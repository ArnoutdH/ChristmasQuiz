...
def main():
    ...
    if "auth4" not in st.session_state:
        st.session_state.auth4 = False
    ...
    if not st.session_state.auth4 and (st.session_state.auth0 and st.session_state.auth1 and st.session_state.auth2 and st.session_state.auth3):
        # --- Placeholders ---
